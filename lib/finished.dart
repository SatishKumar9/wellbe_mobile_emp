...
class finishedCamps extends StatefulWidget {
  @override
  _finishedCampsState createState() => _finishedCampsState();
}

class _finishedCampsState extends State<finishedCamps> {
                      ...
                      child: Column(
                        children: <Widget>[
                          ListTile(
                            ...
                            title:
                              Text("Camp name: ${finished[index]["campname"]}"),                               
                            subtitle: new Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                                SizedBox(height:10.0),
                                Text("${finished[index]["campname"]} will be organised by ${finished[index]["orgname"]}")
                              ],
                            ),
